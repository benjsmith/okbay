...
contrib/okbay-open-full-product.sh  Super+Shift+K full product 2x2 workspace (Atlas|Nautilus/Herdr|okstratr; Ctrl+K Mac alt)
contrib/okbay-open-atlas.sh  Atlas Chromium focus-or-launch (used by full-product)
